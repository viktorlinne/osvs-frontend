    ...
    <PageContainer size="xl" className="ui-page">
      ...
      <div className="grid w-full grid-cols-1 gap-8 lg:grid-cols-3">
        <section className="space-y-6">
          <div className="flex h-56 w-full items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-neutral-100">
            <img
              src="/info.png"
              alt="Ordensamfundet VS"
          ...
          <div>
            <p className="ui-chapter mb-3">Samfundet består av</p>
            <ul className="space-y-2">
              {(
                [
                  ["Stamlogen i Karlskrona", "bildad 7 september 1924"],
                  ["Logen Stella Polaris i Helsingborg", "21 mars 1931"],
                  ["Logen Regulus i Ängelholm", "15 januari 1933"],
                  ["Logen Orion i Göteborg", "bildad 26 februari 1943"],
                  ["Logen Capella i Halmstad", "28 november 1975"],
                ] as [string, string][]
              ).map(([name, date]) => (
                <li
                  key={name}
        ...
        <section className="space-y-6 text-sm text-neutral-700">
          <div className="space-y-3">
            <h2 className="ui-section-title">Vad vill VS?</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="ui-section-title">Vad kan VS erbjuda dig?</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="ui-section-title">Vad är VS?</h2>
            <p>
        ...
        <section className="space-y-6 text-sm text-neutral-700">
          <div className="space-y-3">
            <h2 className="ui-section-title">Varför bara män?</h2>
            <p>
          ...
          <div className="space-y-3">
            <h2 className="ui-section-title">VS Damerna</h2>
            <p>
